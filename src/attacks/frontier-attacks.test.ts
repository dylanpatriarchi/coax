...
import { manyShotJailbreakModule, skeletonKeyModule, policyPuppetryModule } from './index.js';
...
const MODULES: AttackModule[] = [manyShotJailbreakModule, skeletonKeyModule, policyPuppetryModule];
